...
// Defined as a regular function outside the component
        ...
        <Paper elevation={3} sx={{ p: { xs: 2, md: 4 }, borderRadius: 2 }}>
          ...
          <Grid container spacing={2} mt={4} sx={{ border: '1px solid #e0e0e0', borderRadius: 2, p: 3, backgroundColor: '#f9f9f9' }}>
            ...
            <Grid container spacing={2} mt={1} pl={2} pr={2}>
              <Field label="Point To Point Book Id" value={pointToPointBookId} />
                    ...
                    >
                      ...
                      <Grid container spacing={2}>
                        ...
                        <Grid item xs={6}>
                          ...
                          <Typography variant="body1">
                            {option.PointToPointBookExtraOption?.quantity || option.quantity || 1}
                          </Typography>
                        </Grid>
                      </Grid>
                    </Paper>
